...
namespace Elecciones_Europeas.src.controller
{
    public class GraphicController
    {
        ...
        //RELOJ
        public void EntraReloj()
        {
            if (ipfActivo.Valor == 1) { ipf.RelojEntra(); }
        }
        ...
        //TICKER
        public void TickerEntra(bool oficial)
        {
            if (ipfActivo.Valor == 1)
            {
                ipf.TickerEntra(oficial);
                prime.SubirRotulosEspeciales();
            }
        }
        public void TickerEncadena(bool oficial)
        {
            if (ipfActivo.Valor == 1) { ipf.TickerEncadena(oficial); }
        }
        public void TickerActualiza()
        {
            if (ipfActivo.Valor == 1) { ipf.TickerActualiza(); }
        }
        public void TickerSale(bool oficial)
        {
            if (ipfActivo.Valor == 1)
            {
                ipf.TickerSale(oficial);
                prime.BajarRotulosEspeciales();
            }
        }
        ...
        public void PP_PSOEaGenerales()
        {
            if (ipfActivo.Valor == 1) { ipf.PP_PSOEaGenerales(); }
        }
        public void PP_PSOEaEuropeas()
        {
            if (ipfActivo.Valor == 1) { ipf.PP_PSOEaEuropeas(); }
        }
        ...
        {
            if (ipfActivo.Valor == 1) { ipf.participacionEntra(); }
        }
        public void participacionEncadena()
        {
            if (ipfActivo.Valor == 1) { ipf.participacionEncadena(); }
        }
        ...
        //CCAA
        public void ccaaEntra()
        {
            if (ipfActivo.Valor == 1) { ipf.ccaaEntra(); }
        }
        ...
        //FICHAS DE PARTIDO
        public void fichaEntra()
        {
            if (ipfActivo.Valor == 1) { ipf.fichaEntra(); }
        }
        public void fichaEncadena()
        {
            if (ipfActivo.Valor == 1) { ipf.fichaEncadena(); }
        }
        public void fichaSale()
        {
            if (ipfActivo.Valor == 1) { ipf.fichaSale(); }
        }
        ...
        //MAYORIAS
        public void mayoriasEntra()
        {
            if (ipfActivo.Valor == 1) { ipf.mayoriasEntra(); }
        }
        public void mayoriasEncadena()
        {
            if (ipfActivo.Valor == 1) { ipf.mayoriasEncadena(); }
        }
