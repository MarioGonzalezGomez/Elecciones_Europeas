    ...
    internal class CartonMensajes : IPFMensajesBase
    {
        ...
        public string cartonPartidosEntra(BrainStormDTO dto)
        {
            ...
            foreach (PartidoDTO par in dto.partidos)
            {
                ...
                sb.Append(EventBuild($"Mayorias1/{siglasOK}/Partido_Votos1", "TEXT_STRING", $"'{par.numVotantes.ToString("N0", formato)}\\\\f<Light> votos'", 1) + "\n");
            }
        ...
        public string ultimoActualiza(BrainStormDTO dto)
        {
            ...
            //
            //     // Ocultar el partido
            //     string siglasOcultar = partido.siglas.Replace("+", "_").Replace("-", "_").Replace(" ","");
