...
namespace Elecciones_Europeas.src.mensajes.builders
{
    internal class IPFMensajes
    {
        ...
        public string PP_PSOEaGenerales()
        {
            return EventRunBuild("TICKER/PP_PSOE/A_GENERALES");
        }
        public string PP_PSOEaEuropeas()
        {
            return EventRunBuild("TICKER/PP_PSOE/A_EUROPEAS");
        }
        ...
        {
            return Entra("PARTICIPACION");
        }
        public string participacionEncadena()
        {
        ...
        //FICHAS DE PARTIDO
        public string fichaEntra()
        {
            return Entra("CARTONES");
        }
        public string fichaEncadena()
        {
            return EventRunBuild("CARTONES/CAMBIA");
        }
        public string fichaSale()
        {
            return Sale("CARTONES");
        }
        ...
        //MAYORIAS
        public string mayoriasEntra()
        {
            return Entra("MAYORIAS");
        }
        public string mayoriasEncadena()
        {
